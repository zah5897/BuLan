package com.mingmay.bulan.ui.chat;
...
import com.mingmay.bulan.app.hx.Constant;
import com.mingmay.bulan.app.hx.EmojiconExampleGroupData;
...
//				}
	...
	public void onEnterToChatDetails() {
		if (chatType == Constant.CHATTYPE_GROUP) {
			...
			startActivityForResult(new Intent(getActivity(),
					RoomDetailsActivity.class).putExtra("roomId",
					toChatUsername), REQUEST_CODE_GROUP_DETAIL);
		}
	}
	...
	public void onAvatarClick(String username) {
		...
		Intent intent = new Intent(getActivity(), FriendInfoPage.class);
//		intent.putExtra("username", username);
		intent.putExtra("friend", new User(Long.parseLong(username)));
		startActivity(intent);
	}
...
//				RedPacketConstant.MESSAGE_ATTR_IS_RED_PACKET_MESSAGE, false)) {
//			RedPacketUtil.openRedPacket(getActivity(), chatType, message,
//					toChatUsername, messageList);
//			return true;
//		}
		return false;
	}
...
//			if (action
//					.equals(RedPacketConstant.REFRESH_GROUP_RED_PACKET_ACTION)
...
//					toChatUsername, REQUEST_CODE_SEND_MONEY);
//			break;
		default:
			break;
		}
...
//				} else if (message.getBooleanAttribute(
//						RedPacketConstant.MESSAGE_ATTR_IS_RED_PACKET_MESSAGE,
//						false)) {
//					// sent redpacket message
//					return message.direct() == EMMessage.Direct.RECEIVE ? MESSAGE_TYPE_RECV_MONEY
//							: MESSAGE_TYPE_SEND_MONEY;
//				} else if (message
//						.getBooleanAttribute(
//								RedPacketConstant.MESSAGE_ATTR_IS_RED_PACKET_ACK_MESSAGE,
//								false)) {
//					// received redpacket message
//					return message.direct() == EMMessage.Direct.RECEIVE ? MESSAGE_TYPE_RECV_LUCKY
//							: MESSAGE_TYPE_SEND_LUCKY;
				}
			}
			return 0;
		}
...
//					if (message.getBooleanAttribute(
//						RedPacketConstant.MESSAGE_ATTR_IS_RED_PACKET_MESSAGE,
//						false)) {// send redpacket
//					return new ChatRowRedPacket(getActivity(), message,
//							position, adapter);
//				} else if (message
//						.getBooleanAttribute(
//								RedPacketConstant.MESSAGE_ATTR_IS_RED_PACKET_ACK_MESSAGE,
//								false)) {// open redpacket message
