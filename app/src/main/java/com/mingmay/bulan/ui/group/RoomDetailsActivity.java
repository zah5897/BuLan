...
public class RoomDetailsActivity extends BaseActivity implements
		OnClickListener {
	...
	public static RoomDetailsActivity instance;
	...
	public void clearGroupHistory() {
		EMClient.getInstance().chatManager()
				.deleteConversation(room.getId(), true);
		Toast.makeText(this, "聊天室信息已清空", 0).show();
	}
	...
	public void onClick(View v) {
		...
		case R.id.clear_all_history: // 清空聊天记录
			...
			new EaseAlertDialog(RoomDetailsActivity.this, null, st9, null,
					new AlertDialogUser() {
				...
				button.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						if (isInDeleteMode) {
							...
							if (EMClient.getInstance().getCurrentUser()
									.equals(username)) {
								new EaseAlertDialog(RoomDetailsActivity.this,
