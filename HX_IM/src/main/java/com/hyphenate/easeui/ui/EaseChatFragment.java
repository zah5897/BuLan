...
public class EaseChatFragment extends EaseBaseFragment implements
	...
	protected void setUpView() {
		...
		if (chatType == EaseConstant.CHATTYPE_SINGLE) {
			...
			titleBar.setRightImageResource(R.drawable.msg_center_icon);
		} else {
			titleBar.setRightImageResource(R.drawable.msg_center_icon);
		...
		titleBar.setLeftImageResource(getResource("back_selector"));
	}
		...
		chatRoomChangeListener = new EMChatRoomChangeListener() {
			...
			public void onChatRoomDestroyed(String roomId, String roomName) {
				if (roomId.equals(toChatUsername)) {
					...
					// " with room name : " + roomName + " was destroyed");
					getActivity().finish();
				}
			}
	...
	private void sendAtMessage(String content) {
		...
		message.setAttribute(
				...
				EaseAtMessageHelper.get()
						.atListToString(
								EaseAtMessageHelper.get().getAtMessageUsername(
										content)));
		sendMessage(message);
